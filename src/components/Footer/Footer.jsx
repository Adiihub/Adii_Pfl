...
const Footer = () => {                
  return (                              
    <div
      id="Contact"
      className="flex flex-wrap justify-between bg-gradient-to-r from-gray-900 via-black to-gray-800 text-white p-10 md:p-10 md:pt-16 items-center rounded-t-xl shadow-lg"
    >
      {/* Contact Heading */}
      <div className="text-center md:text-left mb-6 md:mb-4 md:ml-16">
