...
import { SiPython, SiNextdotjs, SiMysql, SiMongodb, SiC, SiRedux, SiTailwindcss, SiTypescript, SiExpress } from "react-icons/si";
        ...
        <div className="flex flex-col gap-8 w-full md:w-2/5">
          ...
          <div className="flex gap-6 bg-gray-800 bg-opacity-50 shadow-lg rounded-lg p-6 items-center hover:scale-105 transition duration-300">
            ...
            <div className="text-gray-300">
              ...
              <ul className="list-disc list-inside">
                <li>Developed responsive and scalable user interfaces using Next.js, TypeScript, React.js, and Tailwind CSS.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex gap-6 bg-gray-800 bg-opacity-50 shadow-lg rounded-lg p-6 items-center hover:scale-105 transition duration-300">
            ...
            <div className="text-gray-300">
              ...
              <ul className="list-disc list-inside">
                <li>Mastered essential data structures: arrays, linked lists, stacks, queues, trees, graphs, DP, Greedy Algorithms</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex gap-6 bg-gray-800 bg-opacity-50 shadow-lg rounded-lg p-6 items-center hover:scale-105 transition duration-300">
            ...
            <div className="text-gray-300">
              ...
              <ul className="list-disc list-inside">
                <li>Gained hands-on experience in various Python libraries such as NumPy, Pandas, and Matplotlib & learned how to apply them to real-world data problems.</li>
              </ul>
            </div>
          </div>
        </div>
